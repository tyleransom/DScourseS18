...
\begin{enumerate}
	...
	\item Check that everything works by typing \texttt{ls} and hitting enter. You should see a directory called ``DScourseS18'' and if you change to that directory, you should see an identical directory and file structure to what is on GitHub.
\end{enumerate}
...
\question Change back to your home directory (\texttt{cd \~}) and then type:\\ \texttt{module load libxml2/2.9.3-GCC-4.9.3-2.25}.
