...
\begin{questions}
\question Create an account at \url{GitHub.com} and ``follow'' our class repository (\url{github.com/tyleransom/DScourse18}). Please add a photo of yourself to your profile; this will make it easier for all of us to interact throughout the course.
